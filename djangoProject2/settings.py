...
SECRET_KEY = 'django-insecure-7@@e9u3s70-cv)u)^ibm=%b61gxvb#x003_q1s8zw8mangxq=@'
...
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.postgresql',  # PostgreSQL kullanıyorsan
        'NAME': 'postgres',                  # Veritabanı adı
        'USER': 'postgres',                   # Veritabanı kullanıcı adı
        'PASSWORD': '5639',                       # Veritabanı şifresi
